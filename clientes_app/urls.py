...
urlpatterns = [
    ...
    path("cliente/seleccionarCliente/<id_cliente>/", views.seleccionarCliente, name="seleccionarCliente"),  # Ruta para seleccionar un cliente
    path("editarCliente/", views.editarCliente, name="editarCliente"),  # Ruta para editar un cliente
    path("cliente/borrarCliente/<int:id_cliente>/", views.borrarCliente, name="borrarCliente"),  # Ruta para borrar un cliente
]
